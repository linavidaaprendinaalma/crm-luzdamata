  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-mata-bark px-6 py-10">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 78% 42%, rgba(212,175,105,0.12), transparent 55%)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div
          className="rounded-3xl border border-mata-gold/30 bg-mata-bark/70 backdrop-blur-md px-8 py-10 text-center shadow-[0_0_60px_-15px_rgba(212,175,105,0.35)]"
        >
        ...
        <div className="hidden sm:flex justify-center gap-10 mt-8 text-mata-gold/80">
